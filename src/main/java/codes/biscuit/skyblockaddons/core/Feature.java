...
public enum Feature {
    ...
    DISABLE_EMBER_ROD(2, "settings.disableEmberRodAbility", false),
    ...
    IGNORE_ITEM_FRAME_CLICKS(16, "settings.ignoreItemFrameClicks", true),
    ...
    AVOID_PLACING_ENCHANTED_ITEMS(30, "settings.avoidPlacingEnchantedItems", false),
    AVOID_BREAKING_STEMS(32, "settings.avoidBreakingStems", new GuiFeatureData(ColorCode.RED, true), false, EnumUtils.FeatureSetting.ENABLE_MESSAGE_WHEN_ACTION_PREVENTED),
    ...
    AVOID_BREAKING_BOTTOM_SUGAR_CANE(44, "settings.avoidBreakingBottomSugarCane", false),
    ...
    CRAFTING_PATTERNS(47, "settings.craftingPatterns", false),
    ...
    ONLY_MINE_ORES_DEEP_CAVERNS(56, "settings.onlyMineOresDeepCaverns", new GuiFeatureData(ColorCode.RED, true), true, EnumUtils.FeatureSetting.ENABLE_MESSAGE_WHEN_ACTION_PREVENTED),
    ...
    ONLY_MINE_VALUABLES_NETHER(59, "settings.onlyMineValuablesNether", new GuiFeatureData(ColorCode.RED, true), true, EnumUtils.FeatureSetting.ENABLE_MESSAGE_WHEN_ACTION_PREVENTED),
    ...
    ONLY_BREAK_LOGS_PARK(89, "settings.onlyBreakLogsPark", new GuiFeatureData(ColorCode.RED, true), false, EnumUtils.FeatureSetting.ENABLE_MESSAGE_WHEN_ACTION_PREVENTED),
